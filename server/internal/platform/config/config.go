...
func (conf *Config) SetOptions(opts ...Option) error {
...
func WithFile(file string) Option {
	return func(conf *Config) error { return conf.LoadFromFile(file) }
}

func WithMap(values map[string]any) Option {
